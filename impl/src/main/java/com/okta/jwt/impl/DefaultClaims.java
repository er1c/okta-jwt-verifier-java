 ...
 *
 * Adapted from: https://github.com/jwtk/jjwt/blob/master/impl/src/main/java/io/jsonwebtoken/impl/DefaultClaims.java
 *
...
import com.okta.jwt.RequiredTypeException;
...
public class DefaultClaims extends JwtMap implements Claims {
     ...
     * <code>scp</code></a> (issuer) value or {@code null} if not present.
     *
     * @return the JWT {@code scp} value or {@code null} if not present.
     */
    @Override
    public String[] getScopes() {
        return get(Claims.SCOPES, Date.class);
    }
    ...
    public Claims setScopes(java.lang.Iterable<String> scopes) {
     ...
     */
    @Override //only for better/targeted JavaDoc
    public Claims setScopes(String... scopes) {
