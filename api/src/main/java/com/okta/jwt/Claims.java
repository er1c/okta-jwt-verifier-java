 ...
 *
 * Adapted from: https://github.com/jwtk/jjwt/blob/master/api/src/main/java/io/jsonwebtoken/Claims.java
 *
 ...
 * {@link Jwt#claims() JWT.claims()} factory methods.</p>
 *
 * @since 0.1
 */
public interface Claims extends Map<String, Object>, ClaimsMutator<Claims> {
    ...
    /** JWT {@code JWT Scopes} claims parameter name: <code>"scp"</code> */
     ...
     *
     * <p>Jwt only converts simple String, Date, Long, Integer, Short and Byte types automatically.</p>
     *
    ...
    /**
     * Returns the JWT <a href="https://datatracker.ietf.org/doc/html/draft-ietf-oauth-token-exchange-06#section-4.2">
     * <code>scp</code></a> (Scopes) value or {@code null} if not present.
     *
     * @return the JWT {@code scp} value or {@code null} if not present.
     */
    String[] getScopes();
     ...
     */
    @Override //only for better/targeted JavaDoc
    Claims setScopes(java.lang.Iterable<String> scopes);

    /**
     * {@inheritDoc}
     */
    @Override //only for better/targeted JavaDoc
    Claims setScopes(String... scopes);
}