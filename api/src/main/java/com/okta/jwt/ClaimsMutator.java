 ...
 *
 * Adapted from: https://github.com/jwtk/jjwt/blob/master/api/src/main/java/io/jsonwebtoken/ClaimsMutator.java
 *
...
/**
 * Mutation (modifications) to a {@link com.okta.jwt.Claims Claims} instance.
 *
 * @param <T> the type of mutator
 * @see com.okta.jwt.Jwt
 * @see com.okta.jwt.Claims
 * @since 0.2
 */
public interface ClaimsMutator<T extends ClaimsMutator> {
    ...
    /**
     * Sets the JWT <a href="https://datatracker.ietf.org/doc/html/draft-ietf-oauth-token-exchange-06#section-4.2">
     * <code>scp</code></a> (Scopes) value.  A {@code null} value will remove the property from the JSON map.
     *
     * <p>This value is a
     * @param scopes the JWT {@code scp} value or {@code null} to remove the property from the JSON map.
     * @return the {@code Claims} instance for method chaining.
     */
    T setScopes(java.lang.Iterable<String> scopes);
